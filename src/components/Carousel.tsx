...
// Define props type for Carousel component
type CarouselProps = {
    images: string[];
    autoSlide?: boolean;
...
const Carousel = ({ images, autoSlide = true, autoSlideInterval = 5000 }: CarouselProps) => {
    ...
    const [visibleImages, setVisibleImages] = useState<number>(getVisibleImages());
