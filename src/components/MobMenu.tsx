...
const MenuComponent: React.FC<MenuComponentProps> = ({ Menus }) => {
  ...
  const handleSubMenuClick = (submenuUrl: string) => {
  ...
  return (
    <div ref={menuRef}>
      ...
      <motion.div
        className="fixed left-0 right-0 top-16 bg-white text-black p-6 pb-20 overflow-hidden mt-16"
        initial={{ x: "-100%" }}
            ...
            return (
              <li key={menu.name}>
                <span
                  ...
                  className="uppercase flex-center-between p-4 hover:bg-orange-500 rounded-md cursor-pointer relative text-ms font-semibold"
