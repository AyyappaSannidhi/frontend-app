...
import { UserRegistration, CompleteUserRegistration } from '../Types/user';
...
const RegisterForm: React.FC = () => {
  ...
  const registerUser = async (userDetails: UserRegistration) => {
    if (!captchaToken) {
      setApiError('Please wait till form is loaded');
      return;
    }
    const completeUserDetails: CompleteUserRegistration = {
      ...userDetails,
      user_type: 'devotee',  // Dynamically set user_type from query
